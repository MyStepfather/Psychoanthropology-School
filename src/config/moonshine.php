...
return [
    ...
    'title' => env('MOONSHINE_TITLE', 'Админпанель'),
    'logo' => env('MOONSHINE_LOGO', '/img/navbar/logo.svg'),
    'logo_small' => env('MOONSHINE_LOGO_SMALL'),

    'route' => [
        'prefix' => env('MOONSHINE_ROUTE_PREFIX', 'adminaaa'),
    ...
    'footer' => [
        'copyright' => 'Школа Психоантропологии',
        'nav' => [
            'https://shkolapa.org' => 'Основной сайт',
        ],
    ],
];
