<div class="my-container-border width-50">
    <div class="padding-wrapper">
        ...
        <div class="position-relative">
            <p class="text_fz15_mob mt-20 first-letter-uppercase">
                {{($taskItem['month'])}}
            </p>
            <h2 class="teaching__title title_fz18_mob">{{ $taskItem['title'] }}</h2>
            <p class="teaching__descr text_fz15_mob mt-20">{!! $taskItem['text'] !!}</p>
            <a class="position-absolute top-0 end-0" href="{{ route('teaching.tasks') }}">
